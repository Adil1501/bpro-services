...
@section('page-title', 'Nieuw Nieuwsbericht Maken')
    ...
    <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="mb-4">
                ...
                <p class="mt-1 text-sm text-gray-500">Laat leeg voor huidige datum/tijd</p>
            </div>
            ...
            <div class="mb-6">
                <label class="inline-flex items-center">
                    ...
                    <span class="ml-2 text-sm text-gray-700">Publiceren (meteen zichtbaar voor bezoekers)</span>
                </label>
            </div>
